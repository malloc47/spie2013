...
%% todo: add middle figure that still has S^V_k
\begin{figure}[htbp]
\centering
...
%% the neighbors of the spurious segment.
...
%% So by grouping all
%% the pixels in the removed segment and its adjacent segments, we form
%% the local region on which we run the energy minimization,
\begin{equation}
...
%% todo: blank out unrelated sections of figure
\begin{figure}[htbp]
\centering
...
\label{fig:perform}
\end{figure}
%% todo: copy updated figures in here with proper y-axis labels
